 ...
 */
export function mediaCreateUploadSession(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateUploadSessionRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/media/upload-sessions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UploadSession$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
