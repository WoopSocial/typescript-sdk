...
| `socialAccounts`                                                                                                                                        | *models.SocialAccountTargetInput*[]                                                                                                                     | :heavy_check_mark:                                                                                                                                      | Social-account targets for this post.<br/><br/>All referenced social accounts must belong to the same project.<br/>Duplicate `socialAccountId` values are invalid.<br/> |