...
| `projectId`                                                                                                                   | *string*                                                                                                                      | :heavy_check_mark:                                                                                                            | Project identifier that the selected social accounts belong to.                                                               |
...
| `socialAccountPosts`                                                                                                          | *models.SocialAccountPost*[]                                                                                                  | :heavy_check_mark:                                                                                                            | Platform-specific post instances.                                                                                             |
