...
```typescript
import { SocialAccount } from "@woopsocial/typescript-sdk/models";
...
| `platform`                                                           | [models.SocialPlatform](../models/social-platform.md)                | :heavy_check_mark:                                                   | Identifies which social media platform this data structure targets.<br/> |
