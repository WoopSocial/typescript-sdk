...
let value: HealthResponse = {
  ...
  timestamp: new Date("2026-03-28T09:30:26.123Z"),
  version: "v1",
};
```
...
| `timestamp`                                                                                   | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) | :heavy_check_mark:                                                                            | Current server time in UTC (ISO 8601) with millisecond precision.                             | 2026-03-28T09:30:26.123Z                                                                      |
